  ...
  return (
    <div className="flex-1 overflow-y-auto pb-20 lg:pb-0 lg:pt-20">
      ...
      <div className="hidden lg:block p-6">
        <h1 className="text-white text-2xl font-light mb-2">Settings</h1>
      ...
      <section className="p-4 lg:p-6">
        ...
        <div className="space-y-3">
          <div className="bg-gray-800 rounded-xl p-4">
            <h3 className="text-white font-medium mb-2">Weight Units</h3>
          ...
          <div className="bg-gray-800 rounded-xl p-4">
            <h3 className="text-white font-medium mb-2">Distance Units</h3>
            <div className="flex gap-2">
              <button className="bg-[#C3A869] text-black px-3 py-1 rounded text-sm font-medium">
                Metric (km/m)
              </button>
          ...
          <div className="bg-gray-800 rounded-xl p-4">
            <h3 className="text-white font-medium mb-2">Default Rest Timer</h3>
      ...
      <section className="p-4 lg:p-6">
        ...
        <div className="space-y-3">
          <div className="bg-gray-800 rounded-xl p-4">
            <h3 className="text-white font-medium mb-2">Default RPE Scale</h3>
          ...
          <div className="bg-gray-800 rounded-xl p-4">
            <h3 className="text-white font-medium mb-2">Auto-progression</h3>
          ...
          <div className="bg-gray-800 rounded-xl p-4">
            <h3 className="text-white font-medium mb-2">Warm-up Sets</h3>
      ...
      <section className="p-4 lg:p-6">
        ...
        <div className="bg-gray-800 rounded-xl p-4">
          <div className="text-center text-gray-400 py-4">
            ...
            <h3 className="text-white font-medium mb-2">AI Features Coming Soon</h3>
      ...
      <section className="p-4 lg:p-6">
        ...
        <div className="space-y-3">
          <div className="bg-gray-800 rounded-xl p-4">
            <h3 className="text-white font-medium mb-2">Backup & Sync</h3>
          ...
          <div className="bg-gray-800 rounded-xl p-4 border border-red-900/50">
            <h3 className="text-white font-medium mb-2">Reset Application</h3>
      ...
      <section className="p-4 lg:p-6">
        ...
        <div className="bg-gray-800 rounded-xl p-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-white font-medium">Lars Eriksson</h3>
