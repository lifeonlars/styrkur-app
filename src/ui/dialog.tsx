...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      style={{
        // Norse neumorphic modal styling with design tokens
        background: 'var(--gradient-neu-sunken)',
        borderRadius: 'var(--radius-neu-lg)',
    ...
    >
      ...
      <DialogPrimitive.Close 
        className={cn(
          ...
          "focus:outline-none focus:ring-2 disabled:pointer-events-none"
        )}
        style={{
          opacity: 0.7,
        ...
        onFocus={(e) => {
          ...
          e.currentTarget.style.boxShadow = '0 0 0 2px var(--norse-gold)'
        }}
        onBlur={(e) => {
